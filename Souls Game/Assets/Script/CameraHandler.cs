...
namespace Souls
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        public float lookSpeed = 0.1f, followSpeed = 0.1f, pivotSpeed = 0.03f, minimumPivot = -35, maximumPivot = 35, cameraSphereRadius = 0.2f, cameraCollisionOffset = 0.2f, minimumCollisionOffset = 0.2f;
